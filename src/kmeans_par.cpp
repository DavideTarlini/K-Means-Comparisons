...
std::vector<std::vector<double>> kmeans_par_single_soa(const int k, const std::vector<std::vector<double>>& points, const std::vector<std::vector<double>> &init_centroids) {
    const int MAX_ITERATIONS = 100;
    const double epsilon = 100;
...
/*
*
*   PARALLEL + SINGLE + SOA + SIMD
*
*/

std::vector<std::vector<double>> kmeans_par_single_soa_simd(const int k, const std::vector<std::vector<double>> &points, const std::vector<std::vector<double>> &init_centroids)
{
    const int MAX_ITERATIONS = 100;
    const double epsilon = 100;
    long dim = points.size();
